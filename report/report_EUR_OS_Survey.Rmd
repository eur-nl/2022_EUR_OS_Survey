...
Open Science increases transparency throughout the research cycle -- hypothesis, methodology, observation, data collection, analysis, and publication --, resulting in increased efficiency and enhanced quality, visibility, and engagement. Open Science also enables the creation of new research questions while promoting collaboration and community building.
...
The present report shows the results combined across the whole institution as well as separately for each school: [International Institute of Social Studies](https://www.iss.nl/en) (ISS), [Erasmus School of Health Policy & Management](https://www.eur.nl/en/eshpm) (ESHPM), [Erasmus School of Philosophy](https://www.eur.nl/en/esphil) (ESPhil), [Erasmus School of Law](https://www.eur.nl/en/esl) (ESL), [Erasmus School of Social and Behavioural Sciences](https://www.eur.nl/en/essb) (ESSB), and [Erasmus School of History, Culture and Communication](https://www.eur.nl/en/eshcc) (ESHCC).[^1]
...
**Open Access**: most respondents consider Open Access publishing important and have at least some experience publishing Open Access. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: most respondents consider Open Data, Materials, and/or Code important. They have some experience re-using data/materials/code developed by others, and some of them share their own data/materials/code. However, such research output is not often shared following the FAIR principles. The top concern is that others might find it difficult to understand their data, materials, and/or code.

**Preregistration**: the majority of respondents think preregistration is not very relevant for their research and have little experience with it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it.

**Open Education**: most respondents think that open educational resources are important and have at least some experience with education materials developed by others. However, they seldom share their own educational materials. The top concern is that they might lose control over the use of their educational resources.

**Societal Engagement**: most respondents think it is important to open the research process to non-academic stakeholders, and a third of them regularly engage with society. The top concern is that it might require too much time, effort, and resources.

**Support at EUR**: the majority of respondents expect institutional support, in particular on open access publishing. Regarding support on how to make data FAIR, some respondents have benefited from attending workshops on good research data management practices.

**Recognition and Rewards**: some respondents declared to feel recognized for their open science activities by being given enough freedom to initiate their own projects. A slightly larger percentage of respondents said that they do not feel recognized for their open science activities and would like more time to dedicate to these practices, as well as get more freedom to initiate their own projects.

## ISS

**Open Access**: most respondents consider Open Access publishing important and have quite some experience publishing Open Access. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: most respondents consider Open Data, Materials, and/or Code quite important. They have some experience re-using data/materials/code developed by others, but do not regularly share their own data/materials/code. Their research output rarely follows the FAIR principles. The top concern is that others might find it difficult to understand their data, materials, and/or code. In addition, they consider reuse of data/materials/code as violating the epistemological framework of their research.

**Preregistration**: respondents think preregistration is important for their research but have almost no experience with it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it.

**Open Education**: respondents think that open educational resources are important and have some (infrequent) experience with education materials developed by others. They share their own educational materials, although not regularly. The top concern is that they might lose control over the use of their educational resources.

**Societal Engagement**: respondents think it is important to open the research process to non-academic stakeholders, and many of them engage with society. The top concern is that it might require too much time, effort, and resources.

**Support at EUR**: the majority of respondents expect institutional support, in particular on open access publishing. Regarding support on how to make data FAIR, most respondents do not know or preferred not to answer, while some of them benefited from attending workshops on good research data management practices or information on institutional websites.

**Recognition and Rewards**: some respondents declared to feel recognized for their open science activities by being given enough freedom to initiate their own projects, as well as by getting trust and praise from colleagues/supervisor/manager. An equal percentage of respondents said that they do not feel recognized for their open science activities and would like more time to dedicate to these practices, as well as get more freedom to initiate their own projects, receive a salary raise, and/or a promotion.

## ESHPM

**Open Access**: most respondents consider Open Access publishing important and have experience publishing Open Access. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: respondents consider Open Data, Materials, and/or Code moderately important. They have little experience re-using data/materials/code developed by others, and sometimes share their own data/materials/code. Their research output sometimes follows the FAIR principles. The top concern is that others might find it difficult to understand their data, materials, and/or code.

**Preregistration**: one third of respondents think preregistration is important for their research, and one third thinks it is not important. They have infrequent experience with it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it. In addition, they believe that preregistration might delay data collection.

**Open Education**: respondents think that open educational resources are important, although one fifth of them think it is not at all important. They have infrequent experience with education materials developed by others and do not typically share their own. The top concern is that they might lose control over the use of their educational resources. In addition, they worry that they might not receive appropriate credit for their educational resources if they make them openly available.

**Societal Engagement**: many respondents think it is important to open the research process to non-academic stakeholders, while some of them think it is not important at all. They have at least some experience engaging with society. The top concern is that it might require too much time, effort, and resources.

**Support at EUR**: many respondents expect institutional support, in particular on open access publishing and open data/materials/code. However, more than one-third of respondents do not expect support from EUR. Regarding support on how to make data FAIR, many respondents do not know or preferred not to answer, while some of them benefited from attending workshops on good research data management practices or information on institutional websites.

**Recognition and Rewards**: many respondents declared to feel recognized for their open science activities by being given enough freedom to initiate their own projects, as well as by getting trust from colleagues/supervisor/manager. Some respondents said that they do not feel recognized for their open science activities and would like more time to dedicate to these practices, as well as get more freedom to initiate their own projects.

## ESPhil

**Open Access**: many respondents consider Open Access publishing important and have some experience publishing Open Access. However, not all respondents consider it important and/or have experience with it. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive. In addition, respondents might not have enough funding to pay Article Processing Charges for Open Access journals.

**Open Data, Materials, and/or Code**: respondents consider Open Data, Materials, and/or Code somewhat important, but one-fifth of them do not consider it important. They have little experience re-using data/materials/code developed by others, and rarely share their own. They are not often aware of the FAIR principles. The top concern is that others might find it difficult to understand their data, materials, and/or code.

**Preregistration**: most respondents think preregistration is not important for their work. Most of them are unaware of this open science practice. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it. In addition, they believe that preregistration might delay data collection and/or lead other people to take their research idea and implement their plan.

**Open Education**: most respondents think that open educational resources are important. They often use educational materials developed by others and share their own. The top concern is that they might not receive appropriate credit for their educational resources if they make them openly available. In addition, they worry that others would ask them to provide assistance for their courses/workshops.

**Societal Engagement**: many respondents think it is important to open the research process to non-academic stakeholders, while a third of them think it is not important at all. Most of them regularly engage with society. The top concern is that it might require too much time, effort, and resources.

**Support at EUR**: many respondents expect institutional support, in particular on open access publishing. A sizable percentage of respondents do not expect support from EUR. Regarding support on how to make data FAIR, all respondents do not know or preferred not to answer.

**Recognition and Rewards**: many respondents said that they do not engage in any open science activities. A similar percentage of respondents declared to feel recognized for their open science activities by being given enough freedom to initiate their own projects. A few respondents said that they do not feel recognized for their open science activities and would like more freedom to initiate their own projects.

## ESL

**Open Access**: respondents consider Open Access publishing important and have some experience publishing Open Access. However, some of them consider it not important and/or have experience with it. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: respondents consider Open Data, Materials, and/or Code somewhat important. Half of them have little to no experience re-using data/materials/code developed by others, and rarely share their own. They are often aware of the FAIR principles or have not followed them when sharing. The top concern is that they might lose control over how their data, materials, and/or code would be used.

**Preregistration**: most respondents think preregistration has little to no importance for their work. Most of them are unaware of this open science practice or have never used it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it. In addition, they believe that preregistration might delay data collection, prevent exploratory research, or stifle creativity or flexibility.

**Open Education**: most respondents think that open educational resources are important. Sometimes they use educational materials developed by others but do not often share their own. The top concern is that they might lose control over how their educational resources are used. In addition, they believe that others might find it difficult to understand their educational resources.

**Societal Engagement**: most respondents think it is important to open the research process to non-academic stakeholders. Sometimes they engage with society. The top concern is that it might require too much time, effort, and resources. In addition, they think it might be difficult to manage expectations of some societal actors (e.g., citizens, politicians).

**Support at EUR**: half of respondents expect institutional support, in particular on open access publishing. A quarter of respondents do not expect support from EUR. Regarding support on how to make data FAIR, many respondents do not know or preferred not to answer, while a quarter of them benefited from attending a workshop on research data management.

**Recognition and Rewards**: many respondents said that they do not feel recognized for their open science activities or they do not engage in any open science activities. Of the people who feel recognized, most of them do not know or preferred not to answer, while the rest experienced more freedom to choose and initiate their own projects. Among the respondents who do not feel recognized for their open science activities, most do not know or preferred not to answer, while some would like more freedom to initiate their own projects.

## ESSB

**Open Access**: all respondents consider Open Access publishing important, and most of them have at least some experience publishing Open Access. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: most respondents consider Open Data, Materials, and/or Code extremely or very important. One-fourth of them regularly re-use data/materials/code developed by others, and one-third regularly share their own. They have at least some knowledge of the FAIR principles and have followed them when sharing. The top concerns are that others might criticze their data, materials, and/or code, as well as find errors in published work.

**Preregistration**: most respondents think preregistration has some importance for their work. Most of them have at least some experience with it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it. In addition, they believe that preregistration might delay data collection.

**Open Education**: most respondents think that open educational resources are important. Sometimes they use educational materials developed by others but do not often share their own. The top concern is that they might not receive appropriate credit for their educational resources if they make them openly available.

**Societal Engagement**: most respondents think it is important to open the research process to non-academic stakeholders. Sometimes they engage with society, but a quarter of them has not done it. The top concern is that it might be difficult to manage expectations of some societal actors (e.g., citizens, politicians).

**Support at EUR**: half of respondents expect institutional support, in particular on open access publishing and open data/materials/code. Around a quarter of respondents do not expect support from EUR. Regarding support on how to make data FAIR, many respondents do not know or preferred not to answer. Several respondents benefited from attending a workshop on research data management, got advice from an expert (e.g., research data steward), and/or use available tools (e.g., EUR Data Repository). 

**Recognition and Rewards**: a third of respondents said that they feel recognized for their open science activities, in particular by having more freedom to choose and initiate their own projects. One third of respondents do not feel recognized for their open science activities and would like more time for them.

## ESHCC

**Open Access**: all respondents consider Open Access publishing important and have some experience publishing Open Access. The top concern is that some journals might not publish findings that are uploaded to a pre-publication archive.

**Open Data, Materials, and/or Code**: most respondents consider Open Data, Materials, and/or Code very important. The majority of them have some experience re-using data/materials/code developed by others and sometimes share their own. They are unaware of the FAIR principles or have not followed them regularly when sharing. The top concern is that others might find it difficult to understand their data, materials, and/or code.

**Preregistration**: half of respondents think preregistration has some importance for their work, while one-third of them thinks it has no importance. Most of them are unaware of this open science practice or have never used it. The top concern is that respondents feel that they need to look at their data before they can decide how to best analyse it.

**Open Education**: most respondents think that open educational resources are very important. They sometimes use educational materials developed by others but do not often share their own. The top concern is that they might not receive appropriate credit for their educational resources if they are openly available. In addition, they believe that others might find it difficult to understand their educational resources and that it might take too much time, effort, and resources.

**Societal Engagement**: most respondents think it is important to open the research process to non-academic stakeholders. Sometimes they engage with society. The top concern is that it might require too much time, effort, and resources.

**Support at EUR**: the majority of respondents expect institutional support, in particular on open access publishing and open data/materials/code. Regarding support on how to make data FAIR, almost half of respondents benefited from attending a workshop on research data management.

**Recognition and Rewards**: most respondents do not know or preferred not to answer. A third of respondents said that they do not feel recognized for their open science activities and would like to receive a promotion, more time for open science activities, or more freedom to choose and initiate their own projects.
...
Open Science increases transparency throughout the research cycle, resulting in increased research efficiency and enhanced research quality, visibility, and engagement. For these reasons, EUR is committed to making Open Science practices the norm among its researchers. It is no surprise that Open and Responsible Science (ORS) is one of the pillars of the [EUR Strategy 2024](https://www.eur.nl/sites/corporate/files/2019-09/eur-strategy-2020-2024_creating-positive-societal-impact_the-erasmian-way.pdf).

The ORS program created this survey in order to gather information on what our researchers struggle with and what practices they want to know more about. The main takeaway of the survey is that most researchers would like more support for Open Access Publishing. The EUR Library has been instrumental in providing support regarding Open Access: they have information sessions and provide one-on-one support to all EUR researchers. These efforts and the recent implementation of the Open Access Regulation have led to 95% of peer-reviewed academic articles published Open Access at the EUR. The library has also initiated a fund for the Open Access publication of books. More information on the services can be found [here](https://www.eur.nl/en/library/research-support/open-access).

Besides Open Access, researchers indicated that they may not always have experience with Open Science practices. For instance, a substantial percentage of researchers indicated that they had not heard of the FAIR principles before taking this survey. The university has a number of initiatives planned to increase awareness of the various aspects of Open Science, and Open Data in particular. Individual support is available to researchers and is provided by the data stewards (as part of the Digital Competence Center) and the EUR Data Repository team.

To recognize and reward Open Science practices, the ORS program created the Open Science Awards, that will be given for the first time in November 2022. The survey results, however, suggest that more attention is needed in the field of rewards and recognition, since most respondents stated that they are unaware of the current and expected recognition for Open Science at the EUR. More tangible benefits for practicing Open Science are needed.

There are efforts underway to further foster and promote Open Science at the EUR. The ORS program endorses the Massive Online Open Course on Open Science (MOOC), currently being developed by an interdiscplinary team based at ERIM and ERS. Additionally, the Open Science Ambassadors of each faculty were asked to write an Open Science white paper that will present a shared vision of Open Science at EUR, which will inspire future plans.

***
***

[^1]: The results of Erasmus School of Economics (ESE) and Rotterdam School of Management (RSM) can be found in the report of the [2021 ERIM Open Science Spring Survey](https://eur-nl.github.io/2021_ERIM_OS_Survey/)).

[^2]: We are grateful to [Mutaleni Nadimi](https://nl.linkedin.com/in/mutaleninadimi), [Ava Irani](https://libguides.eur.nl/prf.php?account_id=151665), [Joy Dijksman](https://nl.linkedin.com/in/joy-dijksman-6a169378), and [Andrea Tarchi](https://nl.linkedin.com/in/andrea-tarchi-5b9343146) for their valuable contribution to this section.
