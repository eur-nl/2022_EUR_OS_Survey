...
The main take away of this survey is that most researchers want support for Open Access Publishing. The EUR library has been instrumental in providing support regarding Open Access, they have information sessions and provide one-to-one support to all EUR researchers, more information on the services can be found [here](https://www.eur.nl/en/library/research-support/open-access).
