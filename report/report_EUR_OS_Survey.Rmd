...
Researchers at EUR that expect support form EUR regarding open science practices (they answered "yes" in the previous question), responded that the top three open science practices they want support with are:
*Pull the top 3 pracices (maybe remove the "I don't know answer)*
...
Researchers at ISS that expect support form EUR regarding open science practices (they answered "yes" in the previous question), responded that the top three open science practices they want support with are:
*Pull the top 3 pracices (maybe remove the "I don't know answer)*
...
Researchers at ESHPM that expect support form EUR regarding open science practices (they answered "yes" in the previous question), responded that the top three open science practices they want support with are:
*Pull the top 3 practices (maybe remove the "I don't know answer)*
...
Researchers at ESSB that expect support form EUR regarding open science practices (they answered "yes" in the previous question), responded that the top three open science practices they want support with are:
*Pull the top 3 practices (maybe remove the "I don't know answer)*
...
Researchers at ESHCC that expect support form EUR regarding open science practices (they answered "yes" in the previous question), responded that the top three open science practices they want support with are:
*Pull the top 3 practices (maybe remove the "I don't know answer)*
...
**This question should be below FAIR (in the data section) and we should clarify that only respondents that said they are aware of them got that question, since most researchers didn't. Also I'm not sure if it is super valuable to have this figure, so maybe remove? (the numbers here are so little not sure they really mean much)..maybe worth checking.**
