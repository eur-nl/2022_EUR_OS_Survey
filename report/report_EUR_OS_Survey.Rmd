...
# Excecutive Summary {#es}

### EUR

*Open Access*: most researchers at EUR have experience publishing their publications Open Access.

*Open data/materials/code*: most researchers at EUR have not re-used public data. A considerable percentage of respondents have published their data/materials/code openly, however, most of these open data/materials/code is not FAIR. 
...
*Societal engagement*: most researchers at EUR think is important, but a third of the respondents engage with society regularly.

*Open Science support*: the majority of researchers at EUR want support on Open Access publishing. 

### ISS

*Open Access*: most researchers at ISS have experience publishing their publications Open Access.

*Open data/materials/code*: some researchers at ISS have  re-used public data. A considerable percentage of respondents have published their data/materials/code openly, however, only a small percentage of these open data/materials/code is FAIR. 
...
*Open Science support*: the majority of researchers at ISS want support on Open Access publishing. 

### ESHPM

*Open Access*: most researchers at ESHPM have experience publishing their publications Open Access.

*Open data/materials/code*: most researchers at ESHPM have not re-used public data. A considerable percentage of respondents have published their data/materials/code openly, and a third of these open data/materials/code is FAIR. 
...
*Open Science support*: the majority of researchers at ESHPM want support on Open Access publishing. 
...
*Open data/materials/code*: a few researchers at ESPhil have re-used public data. The majority of respondents have not published their data/materials/code openly. 
...
*Open Science support*: researchers at ESPhil only want support on Open Access publishing. 
...
*Open data/materials/code*: some researchers at ESL have re-used public data. The majority of respondents have not published their data/materials/code openly.
...
*Open Science support*: the majority of researchers at ESL only want support on Open Access publishing. 
...
*Open data/materials/code*: some researchers at ESSB have re-used public data. A considerable percentage of respondents have published their data/materials/code openly, and some of these open data/materials/code is FAIR. 
...
*Open Science support*: researchers at ESSB want support on Open Access publishing and also support on Open data, materials, and/or code.  
...
*Open data/materials/code*: a third researchers at ESHCC have re-used public data, but the majority of respondents have not published their data/materials/code openly. 
...
*Open Science support*: researchers at ESHCC want support on Open Access publishing and also support on Open data, materials, and/or code.
...
Almost 32% of the respondents from ESSB did not know or preferred not to answer this question, a bit more than 26% of the respondents would like to get more time for open science activities as a reward, almost 16% of the respondents selected that the way they get recognized and rewarded for doing open science was the freedom to choice and initiate their own projects.
...
More than 57% of the respondents from ESHCC did not know or preferred not to answer this question, for the rest, a bit more than 14% of the respondents want to receive a promotion, the exact same percentage, would like to get more time for open science activities as a reward, and the same percentage selected that the way they get recognized and rewarded for doing open science was the freedom to choice and initiate their own projects.
...
Open Science increases transparency throughout the research cycle, resulting in increased research efficiency and enhanced research quality, visibility, and engagement. For these reasons, EUR is committed to making Open Science practices the norm among its researchers.And it is not surprise that Open and Responsible Science (ORS) is one of the pillars for the EUR strategy 2024. Because of this, EUR created an Open and Responsible Science Program.

The first deliverable of the Open and Responsible Science Program is the Open Science initiative, geared towards making our scientific routines more open and engaged with our scholarly and societal stakeholders.
...
The ORS program has also together withe Open Science Ambassadors of each faculty co-created an Open Science white paper, that presents the current state of Open Science at EUR. 
